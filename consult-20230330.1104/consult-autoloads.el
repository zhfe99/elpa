...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "consult-info" '("consult-info--")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "consult-kmacro" '("consult-kmacro--")))
